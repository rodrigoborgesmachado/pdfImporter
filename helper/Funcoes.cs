...
namespace helper
{
    public static class Funcoes
    {
        public static List<string> CarregaMaterias()
        {
            ...
            list.Add("Conhecimentos Gerais");
            list.Add("Conhecimentos Gerais");
            list.Add("Legislação Institucional");
            list.Add("Legislação Institucional");
            list.Add("Legislação Institucional");
            list.Add("Legislação Institucional");
            list.Add("Legislação Institucional");
            ...
            list.Add("Direito Constitucional");
            list.Add("Direito Constitucional");
            list.Add("Direito Administrativo");
            list.Add("Direito Administrativo");
            list.Add("Direito Administrativo");
            list.Add("Direito Administrativo");
            list.Add("Direito Administrativo");
            ...
            list.Add("Direito Administrativo");
            list.Add("Direito Administrativo");
            list.Add("Direito Civil e Processual Civil");
            list.Add("Direito Civil e Processual Civil");
            list.Add("Direito Civil e Processual Civil");
            list.Add("Direito Civil e Processual Civil");
            list.Add("Direito Civil e Processual Civil");
            list.Add("Direito Ambiental");
            list.Add("Direito Ambiental");
            list.Add("Direito Ambiental");
            list.Add("Direito Ambiental");
            list.Add("Direito Ambiental");
